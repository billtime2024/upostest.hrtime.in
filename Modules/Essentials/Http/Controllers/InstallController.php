...
class InstallController extends Controller
{
    ...
    {
        \Log::info('Starting Essentials module installation');
        try {
            DB::beginTransaction();
            ...
            // License validation removed as not needed
            \Log::info('Skipping pos_boot validation');

            $is_installed = System::getProperty($this->module_name.'_version');
            \Log::info('Checking if already installed', ['is_installed' => $is_installed]);
            if (! empty($is_installed)) {
                abort(404);
            }
            ...
            \Log::info('Setting system property', ['key' => $this->module_name.'_version', 'value' => $this->appVersion]);
            System::addProperty($this->module_name.'_version', $this->appVersion);

            DB::commit();
            \Log::info('Essentials module installation completed successfully');
            ...
            DB::rollBack();
            \Log::emergency('Essentials installation failed', ['file' => $e->getFile(), 'line' => $e->getLine(), 'message' => $e->getMessage()]);
