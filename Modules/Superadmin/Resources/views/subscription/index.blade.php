                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            ...
                            <div class="box-body text-center">
                                ...
                                @else
                                    <span style="background-color: #00f; color: #fff; font-weight: bold; padding: 1rem; border-radius: 0.25rem;">Your Plan Ends @ </span><span style="background-color: #f00; color: #fff; font-weight: bold; padding: 1rem; border-radius: 0.25rem;" >{{ @format_date($active->end_date) }} ({{\Carbon::today()->diffInDays($active->end_date)}} @lang('lang_v1.days'))</span>
                                @endif
                            </div>
                        </div>
                    </div>
