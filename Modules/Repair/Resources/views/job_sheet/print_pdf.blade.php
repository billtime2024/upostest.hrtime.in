...
<div class="width-100 box mb-10">
	<table class="no-border table-pdf">
		...
		<tr>
			...
			<td>@lang('repair::lang.'.$job_sheet->service_type)</td>
			<td>{{$job_sheet->job_sheet_no}}</td>
			<td>@if(!empty($job_sheet->delivery_date)){{@format_datetime($job_sheet->delivery_date)}}@endif</td>
		</tr>
	</table>
</div>
<div class="box mb-10">
<table class="table-pdf">
	...
	<tr>
		...
		<td style="padding-top: 0">
			...
			<span class="display_currency" data-currency_symbol="true">
				@format_currency($transaction_payment['amount'])
			</span>
...
<div class="width-100 content-div">
	<div class="width-100">
		<strong>After Repair Checklist:</strong>
	</div>
	@php
		$checklists = [];
		if (!empty($job_sheet->deviceModel) && !empty($job_sheet->deviceModel->repair_checklist)) {
