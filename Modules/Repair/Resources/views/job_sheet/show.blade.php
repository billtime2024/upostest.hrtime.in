                ...
                <div class="box-body" id="job_sheet">
                        ...
                        <tr>
                           ...
                           <td>
                               <b>
                                ...
                                <span>{{$job_sheet->status?->name}}</span>
                           </td>
                        </tr> 
                    </table>
                    <table class="table table-bordered"  style="margin-top: 15px;">
                     ...
                     @php
                        $transactions = \App\Transaction::where("repair_job_sheet_id", $job_sheet->id)->get();
                        $transaction_count = count($transactions);
                        if($transaction_count > 0 ){
                            $transaction = $transactions[0];
                            $transaction_payment = \App\TransactionPayment::where("transaction_id", $transaction->id)->get()[0];
                        }
                        ...
                        <tr>
                            ...
                            @endif
                             <td>
                                ...
                                {{$invoice->invoice_no}}
                                @if (!$loop->last && $invoice->invoice_no != "")
                                    {{', '}}
                                @endif
                                @endforeach
                                @endif
                         ...
                         <tr>
                            <td colspan="2">
                                <b>
                                    ...
                                    <span>{{$job_sheet->technician?->user_full_name}}</span>
                                </b>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <span>{{$job_sheet->comment_by_ss}}</span>
                            </td>
                        </tr>
                    </table>
                    <table class="table table-bordered" style="margin-top: 15px;">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-xs-4">
                                   {{-- @if($job_sheet->checklist[$check] == 'yes')
                                    <span class="selected"><i class="fas fa-check-square text-success fa-lg"></i>{{$check}}</span>
                                    @elseif($job_sheet->checklist[$check] == 'no')
                                    <span class="not_selected"><i class="fas fa-window-close text-danger fa-lg"></i>{{$check}}</span>
                                    @elseif($job_sheet->checklist[$check] == 'not_applicable')
                                    <span class="not_selected"><i class="fas fa-square fa-lg"></i>{{$check}}</span>
                                    @endif --}}
                            ...
                            <td>
                                <style>
                                        @media print {
                                         .col-xs-4:has(> input[type="checkbox"]:not(:checked)) {
                                                display: inline-block;
                                            }
                                        
                                        .col-xs-4:has(> input[type="checkbox"]:checked) {;
                                                display: none;
                                        }
                                    </style>
                                 @foreach($checklists as $check)
                   ...
                   {{-- <table class="table table-bordered" style="margin-top: 15px;">
                        ...
                        <tr>
                             ...
                             @php
                                $transaction = \App\Transaction::where("repair_job_sheet_id", $job_sheet->id)->get()[0];
                                $transaction_payment = \App\TransactionPayment::where("transaction_id", $transaction->id)->get()[0];
                               // dd($transaction_payment);
                            @endphp
                        <tr>
