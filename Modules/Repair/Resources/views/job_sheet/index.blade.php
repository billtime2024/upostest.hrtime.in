...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters'), 'closed' => false])
       ...
       {{-- date filter --}}
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('job_sheet_filter_date', __('messages.date') . ':') !!}
                {!! Form::text('job_sheet_filter_date', null, ['class' => 'form-control', 'readonly', 'placeholder' => 'Select a
                date range']) !!}
            </div>
        </div>
        {{-- end date filter --}}
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#job_sheet_filter_date').daterangepicker(
            dateRangeSettings,
            function (start, end) {
            $('#job_sheet_filter_date').val(
            ...
            pending_job_sheets_datatable = $("#pending_job_sheets_table").DataTable({
                    ...
                    ajax:{
                        ...
                        "data": function ( d ) {
                            ...
                            d.date_range = $('#job_sheet_filter_date').val();
                            @if(in_array('service_staff' ,$enabled_modules))
                    ...
                    columns:[
                        ...
                        { data: 'phone', name : 'contacts.mobile'},
                        ...
                        { data: 'created_at',
                            name: 'repair_job_sheets.created_at'
                             ...
                             {data: 'payment_amount', name:'tp.amount'},
