...
class RepairUtil extends Util
{
    ...
    // public function getRepairByStatus($business_id, $location_id = null)
    // {
    //     $query = JobSheet::join(
    ...
    public function getRepairByStatus($business_id, $location_id = null, $start_date = null, $end_date = null)
    {
        $query = JobSheet::join(
            'repair_statuses as rs',
            'repair_job_sheets.status_id',
        ...
        if (!is_null($start_date) && !is_null($end_date)) {
            $query->whereBetween('repair_job_sheets.created_at', [$start_date, $end_date]);
        }
