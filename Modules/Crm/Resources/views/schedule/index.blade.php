	        ...
	        <div class="row">
	            ...
	            <div class="col-md-4">
	                <div class="form-group">
	                    ...
	                    {!! Form::select('status_filter', $statuses, ['open', 'scheduled', 'none'], ['class' => 'form-control select2', 'form-control select2', 'style' => 'width: 100%;', 'id' => 'status_filter', 'placeholder' => __('messages.all'), 'multiple' => 'multiple']); !!}
	                </div>    
	            </div>
	            <div class="clearfix">
	            </div>
