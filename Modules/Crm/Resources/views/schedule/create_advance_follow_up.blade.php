        ...
        <div class="box box-solid hide hidden_box">
        	<div class="box-body">
		        ...
		        <div class="row">
		            ...
		            <div id="end_datetime_container" class="col-md-4">
		               <div class="form-group">
		        ...
		        <div class="row">
		            <div class="col-md-6">
		                <div class="form-group">
		                    ...
		                    {!! Form::select('schedule_type', $follow_up_types, "call", ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width: 100%;']); !!}
		                </div>
		            </div>
...
<script>
  $("#follow_up_create_status").val("open");
   $("#end_datetime_container").hide();
    $("#follow_up_create_status").on("change", function (e) {
        if(e.target.value === "open" || e.target.value === "scheduled") {
            $("#end_datetime_container").hide();
        }else {
            $("#end_datetime_container").show();
        }
    })
</script>
