<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\Crm\Http\Controllers\ScheduleLogController::class, 'update'], ['id' => $schedule_log->id, 'follow_up_log' => $schedule_log->id ]), 'method' => 'put', 'id' => 'schedule_log_form' ]) !!}
