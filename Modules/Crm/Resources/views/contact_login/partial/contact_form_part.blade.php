...
<div class="row">
	<div class="col-md-12">
	    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm center-block more_btn" data-target="#contact_person_div">@lang('crm::lang.add_contact_persons') <i class="fa fa-chevron-down"></i></button>
	</div>
</div>
