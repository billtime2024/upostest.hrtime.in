        ...
        $('#search_product_for_purchase_return')
            .autocomplete({
                ...
                select: function(event, ui) {
                    if (ui.item.qty_available > 0) {
                        purchase_return_product_row(ui.item.variation_id, $(this).val());
                        $(this).val(null);
                    } else {
...
function purchase_return_product_row(variation_id, search_term = "") {
    ...
    $.ajax({
        ...
        data: { row_index: row_index, variation_id: variation_id, location_id: location_id, serach_term: search_term},
        dataType: 'html',
