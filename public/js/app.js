$(document).ready(function() {
        ...
        "ajax": {
            "url": "/contacts",
             "complete": function(json) {
                const columnsToHide = [];
                json.responseJSON.data.forEach(function(row) {
                    for (let i = 0; i < contact_table.columns().count(); i++) {
                        if ( row[columns[i].data] === null &&
                                columns[i].data.split("custom_field")[0] === "" &&
                                !columnsToHide.includes(i)
                        ) {
                ...
                columnsToHide.forEach(function(index) {
                    contact_table.column(index).visible(false);
                });
            },
            "data": function ( d ) {
    ...
    $(document).on('click', 'a.pay_purchase_due, a.pay_sale_due', function(e) {
        e.preventDefault();
        const current_url = $(this).attr('href');
        $.ajax({
            url: $(this).attr('href'),
            dataType: 'html',
            success: function(result) {
                ...
                const contact_ledger_div = document.querySelector("#contact_ledger_div");
                const pay_contact_due_form = document.getElementById("pay_contact_due_form");
                console.log(contact_ledger_div, pay_contact_due_form);
                if(contact_ledger_div !== null){
                    if(document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(1)  > td:nth-child(2)") !== null){
                 const opening_balance = document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(1)  > td:nth-child(2)").innerText.split("₹")[1].split(",").join("");
                    }
                    if(document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(2)  > td:nth-child(2)") !== null) {
                const  total_purchase = document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(2)  > td:nth-child(2)").innerText.split("₹")[1].split(",").join("");
                    }
                    if(document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(5)  > td:nth-child(2)") !== null) {
                const balanceDue = document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(5)  > td:nth-child(2)").innerText.split("₹")[1].split(",").join("");
                    }
                    
                    if(document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(3)  > td:nth-child(2)") !== null) {
                const total_paid = document.querySelector("#contact_ledger_div > div:nth-child(3) >  table > tbody > tr:nth-child(3)  > td:nth-child(2)").innerText.split("₹")[1].split(",").join("");
                    }
                }else if(pay_contact_due_form) {
                    const opening_balance = document.querySelector("#pay_contact_due_form  > .modal-body > .row > .col-md-6:nth-child(2) > .well")
                }
                    if(contact_ledger_div){
                    document.getElementById('due_payment_type_btn').value = balanceDue;
                    document.querySelector('.well  > span:nth-child(2)').innerText = total_purchase;
                    document.querySelector('.well  > span:nth-child(5)').innerText = total_paid;
                     document.querySelector('.well  > span:nth-child(8)').innerText=  balanceDue;
                       document.querySelector('.well  > span:nth-child(11)').innerText = opening_balance;
                    }else if(pay_contact_due_form) {
                        if(current_url.split("=")[1] == "purchase_return"){
                        const due_amount =  document.querySelector("#pay_contact_due_form  > .modal-body > .row > .col-md-6:nth-child(2) > .well  > span:nth-child(8)").innerText;
                        console.log(due_amount.split(" ")[1].split(",").join(""));
                        document.getElementById('due_payment_type_btn').value = due_amount.split(" ")[1].split(",").join("");
                    }
                }
            },
        });
