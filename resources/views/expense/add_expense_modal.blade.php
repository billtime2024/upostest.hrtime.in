            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id', $business_locations, $default_location, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'expense_location_id', 'onchange' => 'function myfunc(e) {
                                document.getElementById("select_location_id").value = e.value;
                                console.log(e.value, document.getElementById("select_location_id").value );
                        } myfunc(this)'], $bl_attributes); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
...
<script>
    const expenseLocation = document.getElementById("expense_location_id");
    console.log("test")
    expenseLocation.addEventListener("change", function () {
        console.log("change")
    })
     expenseLocation.addEventListener("click", function () {
        console.log("click")
    })
</script>