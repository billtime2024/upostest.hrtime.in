...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">{{ __('lang_v1.gst_sales_report')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('gst_sr_location_filter', __('purchase.business_location') . ':') !!}
                        {!! Form::select('location_id', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all'), 'id' => 'gst_sr_location_filter']); !!}
                    </div>
                </div>
            @endcomponent
        </div>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready( function(){
            ...
            $('#gst_sr_location_filter').change(function() {
                gst_sales_report.ajax.reload();
            });
            gst_sales_report = $('table#gst_sales_report').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.location_id = $('select#gst_sr_location_filter').val();
                    },
                },
                columns: [
