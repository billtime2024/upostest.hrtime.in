                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('location_id', $business_locations, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width:100%', 'multiple' => 'multiple']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id', $categories, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'psr_filter_category_id', 'placeholder' => __('lang_v1.all'), 'multiple' => 'multiple']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('sub_category_id', __('product.sub_category') . ':') !!}
                        {!! Form::select('sub_category_id', $sub_categories, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'psr_filter_sub_category_id', 'placeholder' => __('lang_v1.all'), 'multiple' => 'multiple']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('brand_id', __('product.brand') . ':') !!}
                        {!! Form::select('brand_id', $brands, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'psr_filter_brand_id', 'placeholder' => __('lang_v1.all'), 'multiple' => 'multiple']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="psr_detailed_tab">
                        <div style="display:flex; justify-content: space-around; align-items: center; width: 100%;">
                            <div id="container_service_staff_detailed" style=" width: 50%"></div>
                            <div id="container_purhcase_price" style=" width: 50%"></div>
                        </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
              Highcharts.setOptions({
                        ...
                        const totalUnitChartByBrand = Highcharts.chart('container_unit_by_brand', {
                            chart: {
    ...
    href:  '{{ env("APP_URL") }}',
      style: {
        ...
        fontWeight: "bold",
                        ...
                        const totalSoldChartByBrand = Highcharts.chart('container_sold_by_brand', {
                            chart: {
                                plotBackgroundColor: null,
                                plotBorderWidth: null,
                                plotShadow: false,
    ...
    href:  '{{ env("APP_URL") }}',
      style: {
        ...
        fontWeight: "bold",
                        ...
                        //     })
                        // });
                        const totalUnitChart = Highcharts.chart('container_unit_by_category', {
                            chart: {
                                plotBackgroundColor: null,
                                plotBorderWidth: null,
                                plotShadow: false,
    ...
    href:  '{{ env("APP_URL") }}',
      style: {
        ...
        fontWeight: "bold",
                        ...
                        const totalSoldChart = Highcharts.chart('container_sold_by_category', {
                            chart: {
                                plotBackgroundColor: null,
                                plotBorderWidth: null,
                                plotShadow: false,
                        ...
                        product_sell_report_by_category_datatable = $('table#product_sell_report_by_category').DataTable({
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    data.forEach(newData => {
                                        const name = newData.category_name;
                                        const totalLineSoldy = parseFloat(JSON.parse(newData.subtotal.split(" ")[2].split("=")[1].split(">₹")[0]));
                                        const totalUnitSoldy = parseFloat(JSON.parse(newData.total_qty_sold.split(" ")[5].split("=")[1]));
                                        
                                        totalUnitSold.push({name, y: totalUnitSoldy});
                                        totalLineSold.push({name, y: totalLineSoldy});
                                    })

                                    totalUnitChart.series[0].setData(totalUnitSold, true);
                                    totalSoldChart.series[0].setData(totalLineSold,true);
                                    totalUnitChartByBrand.series[0].setData([], true);
                                    totalSoldChartByBrand.series[0].setData([],true);
                    ...
                    if(typeof product_sell_report_by_brand_datatable == 'undefined') {
                        ...
                        product_sell_report_by_brand_datatable = $('table#product_sell_report_by_brand').DataTable({
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    const data = this.fnGetData();
                                    const totalLineSoldByBrand = [];
                                    const totalUnitSoldByBrand = [];
                                    
                                    data.forEach(newData => {
                                        const name = newData.brand_name;
                                        const totalLineSoldy = parseFloat(JSON.parse(newData.subtotal.split(" ")[2].split("=")[1].split(">₹")[0]));
                                        const totalUnitSoldy = parseFloat(JSON.parse(newData.total_qty_sold.split(" ")[5].split("=")[1]));
                                        
                                        totalUnitSoldByBrand.push({name, y: totalUnitSoldy});
                                        totalLineSoldByBrand.push({name, y: totalLineSoldy});
                                    })

                                    totalUnitChartByBrand.series[0].setData(totalUnitSoldByBrand, true);
                                    totalSoldChartByBrand.series[0].setData(totalLineSoldByBrand,true);
                                    totalSoldChart.series[0].setData([], true);
                                    totalUnitChart.series[0].setData([], true);
                                },
                            });
                        } else {
