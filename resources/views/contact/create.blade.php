<div class="modal-dialog modal-lg" role="document">
  ...
  @endphp
    ...
    <div class="modal-body">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'placeholder' => __('contact.mobile'), 'id' => 'contact']); !!}
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    @php
                        $states = \Modules\Superadmin\Entities\State::all()->pluck('state_name', 'state_name');
                        //array_push($states, array("" => ""));
                        $states->put("", "");
                    @endphp
                    @if (!empty(\Module::find("superadmin")))
          ...
          <div class="col-md-3">
            ...
            @endif
              @if (!empty($custom_labels['contact']['custom_field_5']))
          <div class="col-md-3">
            <div class="form-group">
   ...
   <script>
        const contact_number = document.getElementById("contact");
        contact_number.addEventListener("change", (e) => {
            if(e.target.value.length < 11){
                const item_to_add = "91";
                contact_number.value = item_to_add + e.target.value;
            }
        })
    </script>
