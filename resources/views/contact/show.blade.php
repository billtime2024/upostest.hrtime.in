...
$(document).ready( function(){
    ...
    supplier_stock_report_table = $('#supplier_stock_report_table').DataTable({
        ...
        //             sum_table_col($('#supplier_stock_report_table'), 'quantity_sold')
        //         );
                $('#footer_subtotal').html(__sum_stock($('#supplier_stock_report_table'), 'quantity_sold'));
                $('#footer_current_stock').html(__sum_stock($('#supplier_stock_report_table'), 'current_stock'));
                $('#footer_current_stock_value').text(
                        sum_table_col($("#supplier_stock_report_table"), 'current_stock_value')
                    );
                // $('#footer_current_stock_value').html(__sum_stock($('#supplier_stock_report_table'), 'current_stock_value', 'left'));
