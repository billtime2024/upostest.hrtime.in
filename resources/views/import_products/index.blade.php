    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\App\Http\Controllers\ImportProductsController::class, 'store']), 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'import_product_form' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-4">
                        <br>
                            <button type="submit" id="import_product_btn" class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('messages.submit')</button>
                        </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>38</td>
                        <td>REWARD POINT ENABLE (1/0) <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>Enable reward points for this product (1/0).</td>
                    </tr>
                    <tr>
                        <td>39</td>
                        <td>REWARD POINT AMOUNT <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>Amount of reward points per unit (numeric ≥0).</td>
                    </tr>
...
@section("javascript")
    <script>
        const importProductBtn = document.getElementById("import_product_btn");
        const importProductForm = document.getElementById("import_product_form");
        
        importProductBtn.addEventListener("click", (e) => {
            e.preventDefault();
