        	...
        	<div class="row inner_html_row" style="color: #000000 !important;">
        	    <div class="header">
				    ...
				    <div class="col-xs-12 text-left" style="display: flex">
				        <p style="width: 50% !important;margin: 0;" class="word-wrap">
					    ...
					    <p style="width: 57% !important;margin: 0;" class="word-wrap">
							...
							<!-- Waiter info -->
					    <p style="width: 30% !important;margin: 0; margin-right: 16%" class="word-wrap">
						<span class="pull-left text-left">
