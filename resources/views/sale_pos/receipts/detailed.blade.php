	    ...
	    <div class="inner_html">
        	<div class="row inner_html_row" style="color: #000000 !important;">
        	    <div class="header">
					...
					<p style="width: 50% !important;margin: 0;font-size: 18px;font-weight: 700;" class="word-wrap text-right">
				    ...
				    <div class="col-xs-12 text-left" style="display: flex; justify-content: space-between;">
				        <p style="width: 31%;margin: 0; " class="word-wrap">
					    ...
					    <p style="width: 35%;margin: 0;" class="word-wrap">
					...
					<!-- Head  -->
					<p style="width: 31% !important;margin: 0;" class="word-wrap">
						<span class="pull-left text-left">
							<!-- customer info -->
				    ...
				    <div class="col-xs-4 text-left">
				       ...
				       <div class="col-xs-4 text-left">
				        	<!-- Commission Agent -->
					    <p style="width: 35% !important;margin: 0; margin-left: -13%;" class="word-wrap">
						<span class="pull-left text-left">
				...
				<tr style="background-color: #545775 !important; color: white !important; font-size: 15px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					<td style="background-color: #545775 !important; color: white !important;width: 13% !important;">
                        ...
                        <br />IMEI: {{ implode(', ', $line['sold_imei'] ?? []) }}
                        @elseif($line['item_type'] == 'serial')
                        <br />Serial: {{ implode(', ', $line['sold_serial'] ?? []) }}
                        @endif
	   ...
	   <div class="col-md-6 invoice-col width-40">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #545775 !important; color: white !important" class="font-23 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-10" style="background-color: #545775 !important; color: white !important">
