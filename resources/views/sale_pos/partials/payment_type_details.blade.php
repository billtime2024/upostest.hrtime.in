<div class="payment_details_div @if( $payment_line['method'] !== 'card' ) {{ 'hide' }} @endif" data-type="card" >
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			{!! Form::select("payment[$row_index][card_type]", ['credit' => 'Credit Card', 'debit' => 'Debit Card','visa' => 'Visa', 'master' => 'MasterCard'], $payment_line['card_type'] ?? null,['class' => 'form-control', 'id' => "card_type_$row_index" ]); !!}
		</div>
	</div>
	<div class="col-md-3">
		<div class="form-group">
...
<div class="payment_details_div @if( $payment_line['method'] !== 'credit_note' ) {{ 'hide' }} @endif" data-type="credit_note" >
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("credit_note_number_$row_index", __('lang_v1.credit_note_number')) !!}
			{!! Form::text("payment[$row_index][credit_note_number]", $payment_line['credit_note_number'] ?? '', ['class' => 'form-control', 'placeholder' => __('lang_v1.credit_note_number'), 'id' => "credit_note_number_$row_index"]); !!}
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("credit_note_type_$row_index", __('lang_v1.credit_note_type')) !!}
			{!! Form::select("payment[$row_index][credit_note_type]", ['scheme' => __('lang_v1.scheme'), 'purchase_return' => __('lang_v1.purchase_return'), 'sell_return' => __('lang_v1.sell_return')], $payment_line['credit_note_type'] ?? null,['class' => 'form-control', 'id' => "credit_note_type_$row_index" ]); !!}
		</div>
	</div>
	<div class="clearfix"></div>
</div>
