    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('item_type', ['none' => 'None', 'imei' => 'IMEI', 'serial' => 'Serial'], old('item_type', 'none'), ['class' => 'form-control']) !!}
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::checkbox('enable_reward_points', 1, false, ['class' => 'input-icheck', 'id' => 'enable_reward_points']); !!}
            </div>
        </div>
        <div class="col-sm-4" id="reward_points_per_amount_div" style="display: none;">
            <div class="form-group">
                {!! Form::label('reward_points_per_amount', __('product.reward_points_per_amount') . ':') !!}
                {!! Form::number('reward_points_per_amount', null, ['class' => 'form-control input_number', 'placeholder' => __('product.amount_for_1_point'), 'min' => '0', 'step' => '0.01']); !!}
            </div>
        </div>
