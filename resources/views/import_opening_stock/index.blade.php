    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\App\Http\Controllers\ImportOpeningStockController::class, 'store']), 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'import_opening_sotck_form' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-4">
                        <br>
                            <button type="submit" id="import_opening_sotck_btn" class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('messages.submit')</button>
                        </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ asset('files/import_opening_stock_csv_template.csv') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td>7</td>
                    <td>@lang('lang_v1.imei_numbers') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                    <td>@lang('lang_v1.imei_numbers_help')<br>@lang('lang_v1.one_per_line')</td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>@lang('lang_v1.serial_numbers') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                    <td>@lang('lang_v1.serial_numbers_help')<br>@lang('lang_v1.one_per_line')</td>
                </tr>
            </table>
        @endcomponent
        </div>
...
@section("javascript")
    <script>
        const importOpeningStockBtn = document.getElementById("import_opening_sotck_btn");
        const importOpeningStockForm = document.getElementById("import_opening_sotck_form");
        
        importOpeningStockBtn.addEventListener("click", (e) => {
            e.preventDefault();
            document.querySelector(".loader-con").style.display = "block";
            importOpeningStockForm.submit();
        })
    </script>
@endsection