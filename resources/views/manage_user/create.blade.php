      ...
      <div class="col-md-3">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::radio('default_location_id', null, false, ['class' => 'input-icheck default-location-radio', 'disabled' => true]) !!} {{ __('lang_v1.none') }}
              </label>
            </div>
            @foreach($locations as $location)
            <div class="checkbox">
              <label>
                {!! Form::radio('default_location_id', $location->id, false, ['class' => 'input-icheck default-location-radio', 'disabled' => true]) !!} {{ $location->name }} @if(!empty($location->location_id))({{ $location->location_id}}) @endif
              </label>
            </div>
            @endforeach
          </div>
