...
<body
    ...
    <!--<h4 class="new-notification"><div><b>>>BillTime has released major updates, effective from *10-04-2025*. Users experiencing issues should contact customer support. Thank you.<<</b></div></h4>-->
    <div class="tw-flex thetop">
        ...
        @if (!$pos_layout && request()->segment(1) != 'hms')
