...
<div class="col-md-6" style="display: none;">
    ...
    <div class="input-group">
        ...
        {!! Form::hidden('start_date', \Carbon\Carbon::now()->format( config('constants.default_date_format')), ['class' => 'form-control start-date-picker','placeholder' => __('business.start_date'), 'readonly']); !!}
    </div>
    </div>
</div>
<div class="col-md-6" style="display: none;">
    ...
    <div class="input-group">
        ...
        {!! Form::select('currency_id', $currencies, 53, ['class' => 'form-control select2_register','placeholder' => __('business.currency_placeholder'), 'required']); !!}
    </div>
    </div>
</div>
...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('mobile', null, ['class' => 'form-control','placeholder' => "Enter Contact Number With Country Code", 'id' => 'mobile']); !!}
    </div>
    </div>
</div>
...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('country', "India", ['class' => 'form-control','placeholder' => __('business.country'), 'required']); !!}
    </div>
    </div>
</div>
...
<div class="col-md-6" style="display: none;">
    ...
    <div class="input-group">
        ...
        {!! Form::hidden('state', 
       \App\BusinessLocation::where("business_id",  \App\Business::where("owner_id", \App\User::find(1)["id"])->get()[0]["id"])->get()[0]["state"], ['class' => 'form-control','placeholder' => __('business.state'), 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
<div class="col-md-6" style="display:none;">
    ...
    <div class="input-group">
        ...
        {!! Form::hidden('city', \App\BusinessLocation::where("business_id",  \App\Business::where("owner_id", \App\User::find(1)["id"])->get()[0]["id"])->get()[0]["city"], ['class' => 'form-control','placeholder' => __('business.city'), 'required']); !!}
    </div>
    </div>
</div>
<div class="col-md-6" style="display: none;">
    ...
    <div class="input-group">
        ...
        {!! Form::hidden('zip_code', \App\BusinessLocation::where("business_id",  \App\Business::where("owner_id", \App\User::find(1)["id"])->get()[0]["id"])->get()[0]["zip_code"], ['class' => 'form-control','placeholder' => __('business.zip_code_placeholder'), 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
<div class="col-md-6" style="display: none;">
    ...
    <div class="input-group">
        ...
        {!! Form::hidden('landmark', \App\BusinessLocation::where("business_id",  \App\Business::where("owner_id", \App\User::find(1)["id"])->get()[0]["id"])->get()[0]["landmark"], ['class' => 'form-control','placeholder' => __('business.landmark'), 'required']); !!}
    </div>
    </div>
</div>
<div class="col-md-6" style="display: none;">
...
<!-- tax details -->
@if(empty($is_admin))
    <h3 style="display: none">@lang('business.business_settings')</h3>
    ...
    <div class="col-md-6">
        <div class="form-group" style="display: none;">
            ...
            <div class="input-group">
                ...
                {!! Form::select('fy_start_month', $months, 4, ['class' => 'form-control select2_register', 'required', 'style' => 'width:100%;']); !!}
            </div>
        </div>
    </div>
    <div class="col-sm-6">
...
<button type="button" id="send_otp_button"  role="menuitem" class="tw-dw-btn tw-dw-btn-secondary">Send Otp</button>

<ul role="menu" aria-label="Pagination"><li aria-hidden="true"><button id="submit_button" type="submit"  role="menuitem" class="tw-dw-btn tw-dw-btn-primary">Register</button></li></ul>