        ...
        @if($is_credit_note)
         <div class="col-sm-4">
            <div class="form-group">
                @php
                    $credit_note_prefix = '';
                    if(!empty($business->ref_no_prefixes['creditnote'])){
                        $credit_note_prefix = $business->ref_no_prefixes['creditnote'];
                    }
                @endphp
                {!! Form::label('ref_no_prefixes[creditnote]',"Credit Note" . ':') !!}
                {!! Form::text('ref_no_prefixes[creditnote]', $credit_note_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
        @endif
        <div class="col-sm-4">
