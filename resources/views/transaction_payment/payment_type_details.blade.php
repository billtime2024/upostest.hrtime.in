...
<div class="payment_details_div @if( $payment_line->method !== 'credit_note' ) {{ 'hide' }} @endif" data-type="credit_note" >
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("credit_note_number", __('lang_v1.credit_note_number')) !!}
			{!! Form::text("credit_note_number", $payment_line->credit_note_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.credit_note_number')]); !!}
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("credit_note_type", __('lang_v1.credit_note_type')) !!}
			{!! Form::select("credit_note_type", ['scheme' => __('lang_v1.scheme'), 'purchase_return' => __('lang_v1.purchase_return'), 'sell_return' => __('lang_v1.sell_return')], $payment_line->credit_note_type,['class' => 'form-control select2']); !!}
		</div>
	</div>
	<div class="clearfix"></div>
</div>
