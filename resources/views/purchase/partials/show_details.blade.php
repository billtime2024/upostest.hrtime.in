        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              @endif
              @endif
              <th>@lang('IMEI/Serial Numbers')</th>
            ...
            <tr>
              ...
              <td>
                @if($purchase_line->product->item_type == 'imei')
                  {{ $purchase_line->identifiers->where('type', 'imei')->pluck('identifier')->implode(', ') }}
                @elseif($purchase_line->product->item_type == 'serial')
                  {{ $purchase_line->identifiers->where('type', 'serial')->pluck('identifier')->implode(', ') }}
                @endif
              </td>
