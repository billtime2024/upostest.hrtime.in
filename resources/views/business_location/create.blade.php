            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('state', \Modules\Superadmin\Entities\State::all()->pluck('state_name', 'state_name'), 1, ['class' => 'form-control']); !!}
                    @else
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('show_selling_price_group', __('lang_v1.show_selling_price_group_selection') . ':') !!}
                        {!! Form::hidden('show_selling_price_group', 0) !!}
                        {!! Form::checkbox('show_selling_price_group', 1, true, ['class' => 'input-icheck']); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                @php
