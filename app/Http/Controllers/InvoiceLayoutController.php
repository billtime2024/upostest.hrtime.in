...
class InvoiceLayoutController extends Controller
{
    ...
    private function getDesigns()
    {
        return ['classic' => __('lang_v1.classic').' ('.__('lang_v1.for_normal_printer').')',
            ...
            'new_detailed' => "Detailed 1" .' ('.__('lang_v1.for_normal_printer').')',
            ...
            // 'tally' => 'A4 TALLY INDIAN GST FORMAT',
            // 'newA4' => 'A4 ALTERNATE INDIAN GST FORMAT',
            // '3inch' => 'THERMAL INDIAN GST FORMAT',
            // '3inch_clean' => 'THERMAL CLEANER INDIAN GST FORMAT',
        ];
    }
}
