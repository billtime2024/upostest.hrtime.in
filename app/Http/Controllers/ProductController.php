...
class ProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $product->enable_reward_points = $product_details['enable_reward_points'] ?? 0;
            $product->reward_points_per_amount = $product_details['reward_points_per_amount'] ?? null;
    ...
    public function getProducts()
    {
        if (request()->ajax()) {
            ...
            $search_fields = request()->get('search_fields', ['name', 'sku', 'lot']);
