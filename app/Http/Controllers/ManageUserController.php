    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (!empty($user_data['default_location_id'])) {
                if ($permitted_locations !== 'all' && !in_array($user_data['default_location_id'], $permitted_locations)) {
                    throw new \Exception(__('lang_v1.invalid_default_location'));
                }
            } else {
                // Clear default location if not permitted
