...
class SellController extends Controller
{
    ...
    {
        // Delegate to SellPosController for direct sell functionality
        return app(\App\Http\Controllers\SellPosController::class)->store($request);
    }
    ...
    {
        // Delegate to SellPosController for direct sell functionality
        return app(\App\Http\Controllers\SellPosController::class)->update($request, $id);
    }
    ...
    public function getAvailableImeiSerialNumbers(Request $request)
    {
        ...
        \Log::info('getAvailableImeiSerialNumbers called', [
        ...
        $available_numbers = ImeiNumber::whereHas('purchaseLine', function ($query) use ($business_id, $location_id) {
        ...
        \Log::info('Available IMEI/Serial numbers', ['count' => $available_numbers->count(), 'data' => $available_numbers]);
        \Log::info('Selected IMEI/Serial numbers', ['count' => $selected_numbers->count(), 'data' => $selected_numbers]);
