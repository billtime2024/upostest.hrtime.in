    ...
    */
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            // $whatsapp_otp_request = Request::create('/api/send-otp/'. $request->mobile, 'GET');
            // $whatsapp_otp_response = app()->handle($whatsapp_otp_request);
         
            // if($whatsapp_otp_response->getStatusCode() !== 200){
            //     $output = ['success' => 0,
            //     'msg' => "Not able to send otp",
            // ];
            //     return $output;
            // }
