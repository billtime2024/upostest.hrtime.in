...
class Transaction extends Model
{
    ...
    public function draft_created_by_user()
    {
        return $this->belongsTo(\App\User::class, 'draft_created_by');
    }
    ...
    {
        return $this->hasMany(\Modules\Accounting\Entities\AccountingAccountsTransaction::class, 'transaction_id');
    }
